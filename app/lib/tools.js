export const TOOLS = {
  ...
  "thank-you-note": {
    ...
    tag: "Everyone",
    blurb: "Need to say thanks? Get a warm, genuine thank you note for any occasion in seconds.",
    fields: [
      { id: "occasion", label: "What are you thanking them for?", placeholder: "e.g. a job interview, a gift, help during a hard time, a referral..." },
      { id: "details", label: "Any details to include (optional)", placeholder: "Their name, your relationship, anything specific you want to mention...", optional: true },
    ],
    seo: {
      sections: [
        {
          heading: "Write a thank you note that feels genuine",
          paragraphs: [
            "A good thank you note is short, specific, and warm. The mistake most people make is being vague — 'thanks for everything' — when what lands is naming the exact thing the person did and why it mattered to you. But finding those words on the spot, especially after an interview or a thoughtful gift, is harder than it should be.",
            "This free thank you note writer helps you say it well. Tell it what you're thanking someone for and any details you'd like included, and it writes a warm, sincere note you can send as-is or personalize further. It works for interviews, gifts, favors, support during a tough time, and everyday gratitude.",
          ],
        },
        {
          heading: "How to use it",
          paragraphs: [
            "In the first box, describe what you're thanking the person for. In the optional second box, add their name, your relationship, and any specific detail you want mentioned — the more personal the input, the more heartfelt the note.",
            "Generate, then read it over and add a personal line of your own if you can. A thank you note is one of those small gestures that people genuinely remember, so it's worth getting right.",
          ],
        },
      ],
      faq: [
        { q: "Is the thank you note writer free?", a: "Yes, free with no signup. Describe the occasion and get a warm note in seconds." },
        { q: "Can it write a thank you note after a job interview?", a: "Yes. Interview thank-you notes are one of the most common uses — mention the role and anything specific from the conversation for the best result." },
        { q: "How long should a thank you note be?", a: "Short is good — a few genuine sentences that name what you're grateful for and why. Sincerity matters more than length." },
        { q: "Can I personalize it?", a: "Absolutely. Use the generated note as a starting point and add your own personal touch — a specific memory or detail makes it feel truly yours." },
      ],
    },
  },
  "bio-generator": {
    name: "Bio Generator",
    tag: "Creators",
    blurb: "Need a bio? Get a sharp, scroll-stopping bio for Instagram, LinkedIn, Twitter, or anywhere.",
    fields: [
      { id: "about", label: "Tell us about yourself", placeholder: "What you do, your interests, your vibe, anything you want known..." },
      { id: "platform", label: "Where's it going? (optional)", placeholder: "e.g. Instagram, LinkedIn, Twitter/X, personal website", optional: true },
    ],
    seo: {
      sections: [
        {
          heading: "Write a bio that actually says something",
          paragraphs: [
            "Your bio is tiny but it does a lot of work — it's often the first impression on Instagram, LinkedIn, Twitter, or your website. The hard part is fitting who you are into a few lines that feel like you and not a cliché. Most people freeze, write something generic, and leave it for years.",
            "This free bio generator turns a few notes about yourself into a sharp, tailored bio. Tell it about you and where the bio is going, and it adapts the style to the platform — punchy and personality-forward for Instagram or Twitter, polished and credible for LinkedIn. You get options to make your own.",
          ],
        },
        {
          heading: "How to use it",
          paragraphs: [
            "In the first box, describe yourself: what you do, your interests, the impression you want to give. In the optional second box, name the platform so the tone fits — a LinkedIn bio and an Instagram bio should read very differently.",
            "Generate, pick what fits, and trim it to the platform's character limit if needed. The best bios are specific — one real detail about you beats five generic adjectives.",
          ],
        },
      ],
      faq: [
        { q: "Is the bio generator free?", a: "Yes, free and no signup. Describe yourself and get a ready-to-use bio in seconds." },
        { q: "Does it work for Instagram, LinkedIn, and Twitter?", a: "Yes. Mention the platform and the tone adapts — concise and personality-forward for social, polished and professional for LinkedIn." },
        { q: "How long should a bio be?", a: "It depends on the platform. Instagram and Twitter bios are very short, while LinkedIn allows more room. Lead with the most important thing about you either way." },
        { q: "Can I get a few options?", a: "The tool gives you a strong draft to work from. Run it again with slightly different notes to explore different angles and pick your favorite." },
      ],
    },
  },
  "performance-review": {
