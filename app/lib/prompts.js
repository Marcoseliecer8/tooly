...
Provide the review phrases, grouped by theme.`,
  ...
  "thank-you-note": (v) => `You are a warm, sincere writer. Write a genuine thank you note based on the details below. Keep it short, specific, and heartfelt — name what you're grateful for and why it mattered. Avoid generic filler and clichés. Match a tone that feels personal and real, not formal or stiff.
...
Write only the thank you note.`,
  ...
  "bio-generator": (v) => `You are an expert at writing concise, compelling personal bios. Based on the details below, write a sharp bio that captures the person's personality and what makes them distinctive. ${v.platform ? `Tailor the tone and length for ${v.platform}.` : "Keep it versatile and concise."} Avoid generic adjectives and clichés — lead with specific, real details. Offer a strong single bio the person can use or adapt.
